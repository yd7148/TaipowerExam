...
IMAGE_BASE = r'E:\01-Project\2026-08-Taipower-test\test-pdf\111-2022\電機(一)\提取結果_v111'
...
def main():
    ...
    # Save full report
    report_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'vlm_auto_report_111.json')
