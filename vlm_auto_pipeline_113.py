...
IMAGE_BASE = r'E:\01-Project\2026-08-Taipower-test\test-pdf\113-2024\電機\提取結果_v113'

CIRCUIT_QUESTIONS = [4, 5, 6, 9, 10, 12, 17, 18, 21, 22, 23, 28, 31, 36, 38, 40, 42, 45, 50]

ANSWER_VALUES = {
    4:  {'letter': 'A', 'value': 0,   'unit': 'A',   'type': 'current'},
    9:  {'letter': 'C', 'value': 10,  'unit': 'ohm', 'type': 'rth'},
    17: {'letter': 'D', 'value': 1,   'unit': 'A',   'type': 'i_r1'},
    21: {'letter': 'B', 'value': 1+3**0.5, 'unit': 'ohm', 'type': 'zin'},
    22: {'letter': 'A', 'value': 1.5, 'unit': 'ohm', 'type': 'zin'},
}

ANSWER_LETTERS = {
    1: 'B', 2: 'D', 3: 'B', 4: 'A', 5: 'C', 6: 'B', 7: 'C', 8: 'D', 9: 'C',
    10: 'B', 11: 'A', 12: 'B', 13: 'A', 14: 'D', 15: 'C', 16: 'C', 17: 'D',
    18: 'A', 19: 'D', 20: 'A', 21: 'B', 22: 'A', 23: 'B', 24: 'D', 25: 'C',
    26: 'B', 27: 'B', 28: 'A、C', 29: 'A', 30: 'A', 31: 'B', 32: 'C', 33: 'D',
    34: 'D', 35: 'C', 36: 'B', 37: 'A', 38: 'D', 39: 'C', 40: 'B', 41: 'B',
    42: 'D', 43: 'C', 44: 'B', 45: 'A', 46: 'C', 47: 'A', 48: 'D', 49: 'C',
    50: 'C',
}

QUESTION_TEXT = {
    4: "如右圖所示之電路圖，試求電流I值為何？",
    5: "如右圖所示之電路圖，若I為0 A，試求R與IX值分別為何？",
    6: "如右圖所示之電路圖，試求E值為何？",
    9: "如右圖所示之電路圖，試求a、b兩端戴維寧等效電阻為何？",
    10: "如右圖所示之電路圖，試求I值為何？",
    12: "如右圖所示之電路圖，試求6 Ω之戴維寧等效電路，其RTh、ETh及I值分別為何？",
    17: "如右圖所示之電路圖，試求流經R1之電流值為何？",
    18: "如右圖所示之電路圖，試求伏特計之讀值為何？",
    21: "如右圖所示，有一無限長之網路電路由阻抗Z組成，試求Zin值為何？",
    22: "如右圖所示之電路圖，試求輸入阻抗值為何？",
    23: "如右圖所示之電路圖，試求理想運算放大器輸出電壓V0值為何？",
    28: "如右圖所示之電路圖，電晶體β = 50，若IE = 2 mA，VCB = 2 V，試求IC值為何？",
    31: "如右圖所示之N通道MOSFET電路圖，VDD = 15 V，ID = 10 mA，試求VGS值為何？",
    36: "如右圖所示之電路圖，屬於下列何種邏輯閘？",
    38: "如右圖所示之電路圖，具有完全相同之兩電晶體，β = 200、VBE = 0.7 V，試求VO值為何？",
    40: "如右圖所示之共射極(CE)電晶體放大電路圖，β = 100，試求交流電壓增益AV值為何？",
    42: "如右圖所示之電路圖，電晶體工作在主動區，ICQ = 3 mA，R1 = 2 kΩ，R2 = 30 kΩ，VT = 25 mV，試求基極端等效輸入電阻值為何？",
    45: "如右圖所示，為石英體等效電路圖，試問共振頻率之一為何？",
    50: "如右圖所示為理想放大器電路圖，R1=1kΩ、R2=3kΩ、Ra=1kΩ、Rb=3kΩ、v1=4V、v2=-2V，試求νo值為何？",
}
...
def main():
    ...
    # Save full report
    report_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'vlm_auto_report_113.json')
