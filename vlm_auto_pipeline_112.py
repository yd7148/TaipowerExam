...
IMAGE_BASE = r'E:\01-Project\2026-08-Taipower-test\test-pdf\112-2023\電機(一)\提取結果_v112'

CIRCUIT_QUESTIONS = [1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 15, 16, 18, 20, 22, 24, 25, 29]

ANSWER_VALUES = {
}

ANSWER_LETTERS = {
    1: 'B', 2: 'A', 3: 'D', 4: 'C', 5: 'B', 6: 'C', 7: 'D', 8: 'A', 9: 'B',
    10: 'A', 11: 'D', 12: 'B', 13: 'A', 14: 'A', 15: 'D', 16: '送分', 17: 'A', 18: 'B',
    19: 'D', 20: 'C', 21: 'D', 22: 'A', 23: 'D', 24: 'B', 25: 'C', 26: 'B', 27: 'A',
    28: 'C', 29: 'D', 30: 'A', 31: 'D', 32: 'C', 33: 'B', 34: 'A', 35: 'D', 36: 'C',
    37: 'D', 38: 'C', 39: 'B', 40: 'B', 41: 'C', 42: 'B', 43: 'C', 44: 'B', 45: 'B',
...
def main():
    ...
    # Save full report
    report_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'vlm_auto_report_112_part1.json')
