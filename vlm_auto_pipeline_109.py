...
IMAGE_BASE = r'E:\01-Project\2026-08-Taipower-test\test-pdf\109-2020\電機\提取結果_v109'

CIRCUIT_QUESTIONS = [1, 5, 7, 8, 14, 16, 17, 21, 23, 24, 30, 31, 34, 35, 38, 39, 40, 41, 46]

ANSWER_VALUES = {
    1:  {'letter': 'D', 'value': 38,  'unit': 'ohm', 'type': 'rx'},
    5:  {'letter': 'D', 'value': 5,   'unit': 'A',   'type': 'i'},
    8:  {'letter': 'B', 'value': 50,  'unit': 'ohm', 'type': 'rl'},
    21: {'letter': 'D', 'value': 0.34,'unit': 'H',   'type': 'l'},
    24: {'letter': 'B', 'value': 339.5,'unit': 'W',  'type': 'p'},
}

ANSWER_LETTERS = {
    1: 'D', 2: 'C', 3: 'B', 4: 'B', 5: 'D', 6: 'A', 7: 'C', 8: 'B', 9: 'D',
    10: 'A', 11: 'D', 12: 'A', 13: 'B', 14: 'D', 15: 'A', 16: 'D', 17: 'C',
    18: 'A', 19: 'C', 20: 'A', 21: 'D', 22: 'B', 23: 'C', 24: 'B', 25: 'C',
    26: 'B', 27: 'D', 28: 'D', 29: 'A', 30: 'C', 31: 'A', 32: 'B', 33: 'D',
    34: 'B', 35: 'C', 36: 'A', 37: 'D', 38: 'C', 39: 'B', 40: 'D', 41: 'B',
    42: 'A', 43: 'D', 44: 'A', 45: 'C', 46: 'B', 47: 'C', 48: 'A', 49: '送分',
    50: 'C',
}

QUESTION_TEXT = {
    1: "如右圖所示，為使電路中消耗的總功率為2.5 kW，電阻器Rx的值為何？",
    5: "如右圖所示，流經2 Ω電阻之電流為何？",
    7: "如右圖所示，流經2 Ω電阻之電流為何？",
    8: "如右圖所示，有一40∠0° V，內部電阻為20 kΩ的交流電源，通過一匝數比為20：1之理想變壓器與負載RL連接。求最大功率傳輸的負載電阻值及負載的消耗功率為何？",
    14: "如右圖所示，求理想運算放大器之輸出電壓Vo為何？",
    16: "如右圖所示的差分放大器電路中，R1 = 10 kΩ、R2 = 10 kΩ、R3 = 100 kΩ、Rf = 100 kΩ。如果V1 = 25 mV和V2 = 50 mV，則輸出電壓Vo為何？",
    17: "如右圖所示的維恩電橋電路中，R2 = R3 = 30 kΩ，R4 = 1 kΩ，C2 = C3 = 1 nF。當電橋平衡時，電阻R1的值為何？",
    21: "如右圖所示，有一電阻為R歐姆且電感為L亨利的線圈與50 μF電容器串聯連接。若電源電壓為225∠0° V、60 Hz時，電路中流動的電流為I = 1.5∠-30° A，則線圈的R和L值為何？",
    23: "如右圖所示，電源電流I的值為何？",
    24: "如右圖所示，求A和B間產生的有效功率為何？",
    30: "如右圖所示之穩壓電路，假設 Q1、Q2的 IC = IE(IB忽略)，VBE = 0.7 V，VL = 12 V，則R1：R2為下列何者？",
    31: "如右圖所示之電路，二電晶體參數均為VTH = 0.4 V及kn′ = 120 μA/V2，若M1和M2長寬比為(W/L)1 = 30 和 (W/L)2 = 15，則 ID為以下何者？",
    34: "如右圖所示之差動放大器。電晶體參數如下，μnCox = 100 μA/V2 ，VA = 10，但Q1,2之(W/L)1,2 = 25，Q3之(W/L)3 = 50，Q4之 (W/L)4 = 10。電阻 RD = 10 kΩ。假設偏壓維持節點電壓 VB = VX，若電路的差模電壓增益Ad = (VO2 – VO1) / (Vi1 – Vi2)要達到5 V / V，則IB為何？",
    35: "如右圖所示CMOS數位電路，請問輸出 Y為何種邏輯函數？",
    38: "如右圖所示之集極回授偏壓電路，VCC = 12 V，VBE = 0.7 V，電晶體β =120，RC = 1 kΩ，若 VCE = 6.7 V，則RB為何？",
    39: "如右圖所示之振盪電路，於正常工作下，輸出電壓Vo之頻率為何？",
    40: "如右圖所示電路，電晶體工作於作用區，β = 99，VBE = 0.7 V，熱電壓VT = 26 mV，則此放大電路之電流增益Ai=Io/Ii為何？",
    41: "如右圖所示，其中接面場效電晶體(JFET)之夾止電壓VP = -4 V。已知此接面場效電晶體放大電路的工作點為VDS = 3 V、ID = 1 mA，汲極電阻rd忽略不計，則此電路之小訊號電壓增益Vo/Vi為何？",
    46: "如右圖所示之理想運算放大器電路，流經齊納(Zener)二極體之電流 IZ = 1.5 mA，運算放大器之飽和電壓為±15 V，則R值為何？",
}
...
def main():
    ...
    # Save full report
    report_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'vlm_auto_report_109.json')
